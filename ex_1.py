...
# Цвета
COLORS = [(0, 0, 0), (255, 0, 0), (0, 255, 0), (0, 0, 255), (255, 255, 0), (0, 255, 255), (255, 165, 0)]
color_index = 0
current_color = COLORS[color_index]
eraser_color = (255, 255, 255)  # Ластик түсі
...
while running:
    ...
    if pygame.mouse.get_pressed()[0] and drawing:
        if current_tool == 0:  # Карандаш
            ...
            pygame.draw.circle(canvas, eraser_color, mouse_pos, radius)
